...
# ---------------------------------------------------------------- YOUR CODE
TASK = "Write a short project abstract for a college web application that helps students track their academic deadlines and important events. Keep it clear, professional, and suitable for a project presentation."

CRITERIA = [
    "The abstract must be between 80 and 120 words.",
    "It must clearly explain the problem the project solves.",
    "It must mention at least two important features of the application.",
    "It must use clear, professional English and avoid unnecessary repetition.",
]
# ------------------------------------------------------------ END YOUR CODE
